...
public class TickScriptRegexLiteralImpl extends TickScriptRegexLiteralMixin implements TickScriptRegexLiteral {

  public TickScriptRegexLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
