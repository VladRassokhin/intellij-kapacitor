...
public class TickScriptStringLiteralImpl extends TickScriptLiteralImpl implements TickScriptStringLiteral {

  public TickScriptStringLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
