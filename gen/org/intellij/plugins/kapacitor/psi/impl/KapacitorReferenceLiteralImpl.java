...
public class KapacitorReferenceLiteralImpl extends KapacitorLiteralImpl implements KapacitorReferenceLiteral {

  public KapacitorReferenceLiteralImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getReferenceString() {
    return findNotNullChildByType(REFERENCE_STRING);
  }
