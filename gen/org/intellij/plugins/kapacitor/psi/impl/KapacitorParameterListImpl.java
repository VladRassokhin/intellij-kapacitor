...
public class KapacitorParameterListImpl extends ASTWrapperPsiElement implements KapacitorParameterList {

  public KapacitorParameterListImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KapacitorExpression> getParameters() {
