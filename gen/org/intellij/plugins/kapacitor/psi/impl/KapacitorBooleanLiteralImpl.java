...
public class KapacitorBooleanLiteralImpl extends KapacitorLiteralImpl implements KapacitorBooleanLiteral {

  public KapacitorBooleanLiteralImpl(ASTNode node) {
    super(node);
  }
